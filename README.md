...
Fork of the async-profiler to experiment with AsyncGetStackTrace, a new version of the AsyncGetCallTrace call, in a modified [JDK](https://github.com/parttimenerd/jdk-sandbox/tree/asgct2). It only changes the used API call and can display more information, with a diff which is as small as possible.
