...
class Profiler {
  private:
    ...
    int getJavaTraceAsync(void* ucontext, ASGCT_CallFrame* frames, int max_depth, StackContext* java_ctx, long osThreadId = -1);
  ...
  public:
    ...
    u64 recordSample(void* ucontext, u64 counter, EventType event_type, Event* event, long osThreadId = -1, bool recordNative = true);
